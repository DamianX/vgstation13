...
/mob/living/silicon/ai/verb/pick_icon()
	...
	var/icontype = input("Select an icon!", "AI", null, null) as null|anything in possible_icon_states
	if(!icontype)
		icontype = "Default"
	icon_state = chosen_core_icon_state = possible_icon_states[icontype]
